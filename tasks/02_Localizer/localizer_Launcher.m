...
%                     thisTrialFileName = 'cue_1';
            ...
            for thisStim = 1:vars.StimReps          % loop over the stim reps
                ...
                send_propix_trigger(vars.propixtrigger, vars.triggers.LocStimOnset)
                ...
                %WaitSecs(generate_jitter(vars.ISI_min, vars.ISI_max))
...
%                     scr.fixation.color = {[255,255,255],[0,0,0]};
              ...
              %  WaitSecs(vars.ITI);
                WaitSecs(generate_jitter(vars.ITI_min, vars.ITI_max)) %% added jittered ITI
...
%                     scr.fixation.color = {[255,255,255],[0,0,0]};
                ...
                send_propix_trigger(vars.propixtrigger, vars.triggers.CloseTrigger)
                [~, StimOff] = Screen('Flip', scr.win);
                WaitSecs(generate_jitter(vars.ISI_min, vars.ISI_max)); % jittered isi 
