...
if vars.language == 1       % English
    instr.A     = sprintf('--- 2. Learning task --- \n \n \n \n On each trial, you will first see a picture of either %s or a %s (a cue). \n \n Then you must predict whether the face you will see next is angry or happy (by pressing the LEFT / RIGHT buttons, just as in the Face Discrimination task). \n \n \n \n You will then be shown either an angry or happy face. Press SPACE to see an example trial.', cue_names{3}, cue_names{2});
    instr.B     = 'After each trial, you will rate how confident you felt in your choice by using a slider scale. Use the buttons to move the slider, and SPACE to confirm your rating. You will have 3 seconds to respond. \n \n Let''s try a trial with a confidence rating. \n \n \n \n Press SPACE to continue.';
