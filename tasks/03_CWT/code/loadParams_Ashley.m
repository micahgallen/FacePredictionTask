...
% Select trial reversal sequence using Counterbalancing.mat
load(strcat(vars.OutputFolder, 'visit_cbal'), 'cbal');
if cbal == 1
    chosenSequence = 'sequence1_NEW2.mat';
elseif cbal == 2
    chosenSequence = 'sequence2_NEW2.mat';
elseif cbal == 3
    chosenSequence = 'sequence6_NEW2.mat';
else
    error('Error. cbal must be an int between 1 and 3, not %s.', cbal)
end
% Add 'sequence6.mat'
